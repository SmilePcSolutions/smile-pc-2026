...
export default function NotFound() {
  return (
    <div className="mx-auto max-w-3xl">
      <div className="mt-6 rounded-3xl border border-white/70 bg-white/70 p-8 shadow-sm backdrop-blur md:p-12">
        ...
        <p className="mt-4 text-base leading-relaxed text-slate-600">
          Le lien n’existe pas (ou plus). Utilise les boutons ci-dessous.
        </p>
